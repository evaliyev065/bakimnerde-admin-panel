...
export function BalancesPage() {
  ...
  return <>
    ...
    <div className="toolbar"><label className="table-search"><Search size={16} /><input placeholder="Hareketlerde ara" /></label><button className="button button--primary" onClick={openAdjustment}><Plus size={16} /> Bakiye işlemi</button></div>
